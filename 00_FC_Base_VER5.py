...
Please enter...
- The name of your product and quantity (can't be blank)
- Variable costs( name of item, quantity, price )
- Fixed costs ( answer yes or no, cost name, price )
- Your profit goal ( in $ or % )
- choose value you would like to round off to

When you have entered all your costs, press 'xxx' to quit.

The program will then display the cost details 
including your variable costs,fixed costs, total
costs and profit & sales target with the recommended selling price.
